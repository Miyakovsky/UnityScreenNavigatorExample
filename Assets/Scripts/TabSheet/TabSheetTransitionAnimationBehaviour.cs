...
public class TabSheetTransitionAnimationBehaviour : TransitionAnimationBehaviour
{
    ...
    {
        var sheet = RectTransform.GetComponent<TabContentSheet>();
        var partnerSheet = PartnerRectTransform.GetComponent<TabContentSheet>();
